...
As a **portal user**,
I want **to see real AWS console screenshots in the Text to Speech walkthrough**,
so that **I know exactly what to expect when I deploy and use the scenario**.

## Acceptance Criteria

1. **AC-17.7.1:** Capture all 17 required screenshots for text-to-speech scenario - DONE
...
- `tests/screenshots/text-to-speech.spec.ts` - Screenshot capture script
- `src/assets/images/screenshots/text-to-speech/*.png` - 17 screenshots
