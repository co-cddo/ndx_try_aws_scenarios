...
**Acceptance Criteria:**
- Mermaid diagram showing: Internet → ALB → Fargate → RDS
...
```
Internet → ALB → Fargate (1 task) → RDS MySQL t3.micro
                                    └─ Public subnet
```

**Production Architecture (Reference - aws-samples CDK):**
```
Internet → CloudFront+WAF → ALB → Fargate (auto-scaling) → Aurora Serverless v2
                                                          └─ EFS
                                                          └─ Private subnet + NAT
```
