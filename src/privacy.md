...
description: How we handle your personal information when using NDX:Try
---
...
Sandbox evaluation environments run on AWS infrastructure in the US (us-east-1 N. Virginia region). We use US regions for sandbox evaluations because they offer the widest AWS service availability and lower carbon intensity. Sandbox environments use only sample and synthetic data, contain no real citizen data, and auto-delete after 2 hours.
