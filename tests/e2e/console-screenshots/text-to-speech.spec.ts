...
const STACK_NAME = 'ndx-reference-text-to-speech';
const REGION = 'us-west-2';

const SCREENSHOT_PAGES = [
  { name: 'lambda-synthesizer-overview', service: 'lambda' as const, outputKey: 'SynthesizerFunctionArn' },
  { name: 'lambda-synthesizer-config', service: 'lambda' as const, outputKey: 'SynthesizerFunctionArn' },
  { name: 'lambda-synthesizer-monitoring', service: 'lambda' as const, outputKey: 'SynthesizerFunctionArn' },
  { name: 's3-bucket-audio', service: 's3' as const, outputKey: 'AudioBucketName' },
  { name: 's3-bucket-audio-objects', service: 's3' as const, outputKey: 'AudioBucketName' },
  { name: 's3-bucket-audio-properties', service: 's3' as const, outputKey: 'AudioBucketName' },
  { name: 'polly-console', service: 'lambda' as const, outputKey: 'SynthesizerFunctionArn' },
  { name: 'dynamodb-jobs-table', service: 'dynamodb' as const, outputKey: 'JobsTableArn' },
  { name: 'dynamodb-jobs-items', service: 'dynamodb' as const, outputKey: 'JobsTableArn' },
  ...
  { name: 'cloudwatch-logs-synthesizer', service: 'cloudwatch' as const, outputKey: 'SynthesizerFunctionArn' },
];
