...
export class DatabaseConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DatabaseConstructProps) {
    ...
    this.cluster = new rds.DatabaseCluster(this, 'Aurora', {
      ...
      credentials: rds.Credentials.fromGeneratedSecret('fixmystreet', {
        excludeCharacters: ' "\'\\/@#%:<>?[]^`{|}$&()+,;=~',
      }),
      defaultDatabaseName: 'fixmystreet',
      storageEncrypted: true,
      writer: rds.ClusterInstance.serverlessV2('writer', {
        publiclyAccessible: false,
      }),
      readers: [],
      // Parameter group enabling PostGIS extensions
      parameterGroup: new rds.ParameterGroup(this, 'FmsParams', {
        engine: rds.DatabaseClusterEngine.auroraPostgres({
          version: rds.AuroraPostgresEngineVersion.VER_16_6,
        }),
        parameters: {
          'rds.allowed_extensions': 'plpgsql,postgis,postgis_topology,pgcrypto,pg_stat_statements',
